...
// and prevents it to be iterable and configurable. To avoid that override the those default properties,set
...
// Notice that the property price does not directly belong to myHouse 
//let's verify that
console.log('Does age directly belong to myHouse?: ', myHouse.hasOwnProperty('age'));
console.log('Does price directly belong to myHouse?: ', myHouse.hasOwnProperty('price'));
